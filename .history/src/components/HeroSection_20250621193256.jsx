...
export const HeroSection = () => {
    ...
    >
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center animate-ounce">
            <span className="text-sm text-muted-foregrouns"> Scroll </span>
